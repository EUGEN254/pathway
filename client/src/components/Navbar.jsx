    ...
    <div className="w-full px-4 sm:px-6 lg:px-12 py-4 sm:py-6">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="text-xl sm:text-2xl font-bold tracking-wide">
          <span className="text-black">Pathway</span>
        </div>
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <button className="bg-orange-500 text-white px-5 py-2 rounded-full font-medium hover:bg-orange-600 transition duration-300">
            Sign Up
          </button>
        </div>
